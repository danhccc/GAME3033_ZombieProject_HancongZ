...
public class WeaponHolder : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GameObject spawnWeapon = Instantiate(weaponToSpawn, weaponSocketLocation.transform.position, weaponSocketLocation.transform.rotation, weaponSocketLocation.transform);
